"""Single-row split-KV decode FA3 TLE experimental kernel family."""

from .utils import *  # noqa: F401,F403
from .fa_hopper_decode_onepass import _decode_apply_alibi, _decode_apply_mask
from .fa_hopper_splitkv import (
    flash_varlen_fwd_v3_tle_splitkv_combine_kernel as flash_varlen_fwd_v3_tle_decode_splitkv_combine_kernel,
)


def _fa3_decode_splitkv_configs():
    configs = []
...
def _prune_fa3_decode_splitkv_configs(configs, nargs, **kwargs):
...
@libentry()
@triton.autotune(
    configs=_fa3_decode_splitkv_configs(),
    prune_configs_by={"early_config_prune": _prune_fa3_decode_splitkv_configs},
    key=[
        "d",
        "is_paged",
        "is_causal",
...
def flash_varlen_fwd_v3_tle_decode_splitkv_kernel(
    q_ptr,
    k_ptr,
    v_ptr,
    o_ptr,
